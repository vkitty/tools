...
// query class
var dbQuery = module.exports = function() {
  this.sql = {};
  this.op = {};
  this.conn = {};
};
 ...
 */
dbQuery.prototype.field = function() {
  arg = arguments;
 ...
 *   where('a = 1') -> WHERE a = 1 ...
 */
dbQuery.prototype.where = function() {
  var arg = arguments;
  var join = false;
...
dbQuery.prototype.count = function(){
  this.op.count = 1;
  return this.field(['count(0)', true, 'count']);
};
 ...
 */
dbQuery.prototype.order = function() {
 ...
 * @param {Number} rows
 */ 
dbQuery.prototype.limit = function(offset, rows) {
 ...
 */ 
dbQuery.prototype.page = function(num, rows) {
  num = num || 1;
  rows = rows || 10;
 ...
 */
dbQuery.prototype.join = function() {
  if (typeof arguments[0] === 'string') {
    var arg = [];
    //arg.push(arguments);
    this.sql.table += arguments[0];
    return this;
  } else {
    arg = arguments;
  }
  ...
  for (var i = 0; i < arg.length; i++) {
    this.sql.table += ' LEFT JOIN ' + mescapeId(arg[i][0]);
 ...
 */
dbQuery.prototype.option = function(op) {
  this.op = op;
  return this;
};
 ...
 * select
 */
dbQuery.prototype.select = function(callback) {
  if (this.op.find) {
    this.sql.limit = '1';
  }
 ...
 * find (select limit 1)
 */
dbQuery.prototype.find = function(callback) {
  this.op.find = 1;
 ...
 */
dbQuery.prototype.insert = function(data, callback) {
 ...
 */
dbQuery.prototype.update = function(data, callback) {
  data = data || {};
  callback = callback || function() {};
...
dbQuery.prototype.exec = function(callback) {
  ...
  return new Promise(function(resolve){
    self.conn.query(self.sql.final, function(err, data) {
      if (err) {
        throw err;
      }
      else
